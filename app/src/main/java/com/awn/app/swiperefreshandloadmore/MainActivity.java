package com.awn.app.swiperefreshandloadmore;
...
-Data default akan ditampilkan terlebih dahulu
-Jika user scroll ke bawah dan ListView sudah mencapai bagian paling bawah dari batas layar maka
fungsi load more akan dijalankan. Dan setelah data ditambahkan dibagian paling bawah dari list maka
adapter akan direfresh dengan menggunakan perintah : notifyDataSetChanged()
-Jika user menarik listview ketika ada di posisi paling atas maka fungsi Pull To Refresh akan
dijalankan. Sama seperti dengan load more namun bedanya Pull To Refresh akan menambahkan data dibagian
atas dari list dan kemudian adapter akan direfresh dengan menggunakan perintah : notifyDataSetChanged()
 */